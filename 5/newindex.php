    ...
    if (empty($errors)) {
      try {
          ...
          echo "<div
                    ...
                    background-color: #DBC5D1;
                    border-top: 6px solid #C38DAE;
                    border-left: 6px solid #C38DAE;
                    border-right: 6px solid #C38DAE;
                    width: 50%'>
                <p>Ваш логин: " . htmlspecialchars($login) . "</p></div>";
          echo "<div style='
                    text-align: center;
                    background-color: #DBC5D1;
                    border-bottom: 5px solid #C38DAE;
                    border-left: 5px solid #C38DAE;
                    border-right: 5px solid #C38DAE;
                    width: 50%;
                    margin-bottom: 10px;'>
...
<h2>Регистрация</h2>
<?php
        // Только инициализация переменной, без вывода
